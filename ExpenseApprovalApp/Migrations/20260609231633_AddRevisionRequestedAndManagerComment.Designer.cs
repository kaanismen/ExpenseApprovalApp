...
namespace ExpenseApprovalApp.Migrations
{
    ...
    [Migration("20260609231633_AddRevisionRequestedAndManagerComment")]
    partial class AddRevisionRequestedAndManagerComment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseApprovalApp.Models.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("ExpenseApprovalApp.Models.Entities.ExpenseItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExpenseApprovalApp.Models.Entities.ExpenseRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExpenseApprovalApp.Models.Entities.ExpenseItem", b =>
                {
                    b.HasOne("ExpenseApprovalApp.Models.Entities.ExpenseRequest", "ExpenseRequest")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ExpenseApprovalApp.Models.Entities.AppUser", null)
                        .WithMany()
